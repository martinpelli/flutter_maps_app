...
class CoordsResponse {
  ...
  factory CoordsResponse.fromJson(String str) => CoordsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CoordsResponse.fromMap(Map<String, dynamic> json) => CoordsResponse(
